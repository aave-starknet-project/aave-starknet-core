...
#
# func test_get_siloed_borrowing_state{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
#     PoolStorage.reserves_list_write(TEST_RESERVE_INDEX, TEST_RESERVE_ADDRESS)
#     PoolStorage.reserves_list_write(TEST_RESERVE_INDEX_2, TEST_RESERVE_ADDRESS_2)

# ReserveConfiguration.set_siloed_borrowing(TEST_RESERVE_ADDRESS, TRUE)
#     ReserveConfiguration.set_siloed_borrowing(TEST_RESERVE_ADDRESS_2, TRUE)

# # 1
#     UserConfiguration.set_borrowing(TEST_ADDRESS, TEST_RESERVE_INDEX, TRUE)

# let (siloed_borrowing_state, asset_address) = UserConfiguration.get_siloed_borrowing_state(TEST_ADDRESS)

# assert siloed_borrowing_state = TRUE
#     assert asset_address = TEST_RESERVE_ADDRESS

# # 2
#     UserConfiguration.set_borrowing(TEST_ADDRESS, TEST_RESERVE_INDEX_2, TRUE)
#     let (siloed_borrowing_state, asset_address) = UserConfiguration.get_siloed_borrowing_state(TEST_ADDRESS)

# assert siloed_borrowing_state = FALSE
#     assert asset_address = 0
#     return ()
# end

# func test_get_isolation_mode_state{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
#     PoolStorage.reserves_list_write(TEST_RESERVE_INDEX, TEST_RESERVE_ADDRESS)
#     PoolStorage.reserves_list_write(TEST_RESERVE_INDEX_2, TEST_RESERVE_ADDRESS_2)
#     PoolStorage.reserves_list_write(TEST_RESERVE_INDEX_3, TEST_RESERVE_ADDRESS_3)

# ReserveConfiguration.set_debt_ceiling(TEST_RESERVE_ADDRESS, 1000)
#     ReserveConfiguration.set_debt_ceiling(TEST_RESERVE_ADDRESS_2, 1000)

# # 1
#     UserConfiguration.set_using_as_collateral(TEST_ADDRESS, TEST_RESERVE_ADDRESS, TRUE)
# end

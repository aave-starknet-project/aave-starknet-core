...
namespace IPool:
    ...
    func set_configuration(asset : felt, configuration : DataTypes.ReserveConfigurationMap):
    end

    func get_configuration(asset : felt) -> (reserve_config : DataTypes.ReserveConfigurationMap):
    end
